...
const ErrorPage = () => {
    ...
    return (
        <div>
            ...
            <h1 className='text-2xl md:text-3xl lg:text-4xl font-semibold md:font-bold lg:font-black text-center my-3 md:my-6 lg:my-9 '>We are not found the url : {location.pathname}</h1>
