...
const LearingingIsEarning = () => {
    return (
        ...
        transition={{duration: 2}}
         className='flex gap-4 md:gap-6 lg:gap-8 flex-col-reverse md:flex-row bg-base-200 w-11/12 mx-auto p-4 md:p-6 lg:p-10 rounded-xl md:rounded-2xl lg:rounded-3xl'>
